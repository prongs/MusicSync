define([
    ...
    "dijit/layout/AccordionContainer"], function(declare, ready, array, dom, WidgetBase, TemplatedMixin, template, PersonWidget, registry, ChatTabWidget, TabContainer, ContentPane) {
    return declare("chat.MainViewWidget", [WidgetBase, TemplatedMixin], {
        ...
        startChat: function(person) {
            ...
            var cp = new ContentPane({
                title: person.name,
                closable: true,
                content: "<div><div data-dojo-type='dijit.layout.ContentPane'> hi</div><input type='text' value='sample' ></div>"
            });
